<div class="subscriptions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('is_following'); ?></th>
			<th><?php echo $this->Paginator->sort('being_followed'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($subscriptions as $subscription): ?>
	<tr>
		<td><?php echo h($subscription['Subscription']['id']); ?>&nbsp;</td>
		<td><?php echo h($subscription['Subscription']['is_following']); ?>&nbsp;</td>
		<td><?php echo h($subscription['Subscription']['being_followed']); ?>&nbsp;</td>
		<td class="actions">
